...
<body>
    ...
    $arreglo_estado = $estudiante->EstadoAsincronoDesercion();
    $arreglo_bootcamps = $estudiante->getBootcamps();
    ?>
   
    <main id="main">
        <section class="container">
            <h1>Gestión de estudiantes activos</h1>
            <a href="./registrar_estudiantes.php" class="btn btn-primary mb-3">Registrar</a>
                ...
                <tbody>
                    <?php foreach($arreglo_estudiante as $item){ ?>
                        <tr>
                            ...
                            <td>
                                <form action="./actualizar_estudiantes.php" method="POST">
                        ...
                        <input type="hidden" name="id_estudiante" value="<?php echo $item['id'];?>">
                        <h5><?php echo $item['nombre'];?></h5>
                        <p><strong>Bootcamp Actual: <?php echo $item['bootcamp'];?></strong></p>
                        ...
                        <?php $estudiante->ActualizarBootcamp();?>
                        </div>
                        </div>
                        </div>
                     <?php } ?>
